...
use windows::Win32::UI::Input::KeyboardAndMouse::{
    SendInput, INPUT, INPUT_KEYBOARD, KEYBDINPUT, KEYEVENTF_KEYUP, VK_CAPITAL, VK_LCONTROL,
    VK_MENU, VK_SPACE,
};
use windows::Win32::UI::WindowsAndMessaging::{
    CallNextHookEx, GetMessageW, SetWindowsHookExW, UnhookWindowsHookEx, KBDLLHOOKSTRUCT, MSG,
    WH_KEYBOARD_LL, LLKHF_INJECTED, LLKHF_UP, WM_KEYDOWN, WM_SYSKEYDOWN,
};
...
unsafe extern "system" fn keyboard_hook(
    ...
    unsafe {
        ...
        // 跟踪 Alt 状态(不能用 GetAsyncKeyState:LLKHF_ALTDOWN 只对系统键事件可靠)
        if kb.vkCode == VK_MENU.0 as u32 {
        ...
        if ALT_DOWN.load(Ordering::SeqCst) != 0 {
